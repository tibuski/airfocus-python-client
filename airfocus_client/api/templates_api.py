...
class TemplatesApi:
    ...
    def apply_template_legacy(
        ...
        _param = self._apply_template_legacy_serialize(
            template_id=template_id,
            apply_template_request=apply_template_request,
            act_as_admin=act_as_admin,
            _request_auth=_request_auth,
    ...
    @validate_call
    def apply_template_legacy_with_http_info(
        self,
        template_id: StrictStr,
        apply_template_request: ApplyTemplateRequest,
        act_as_admin: Annotated[Optional[StrictBool], Field(description="Enable sudo-mode for admins for a single request, which gives full permission to all workspaces in the team.")] = None,
    ...
    @validate_call
    def apply_template_legacy_without_preload_content(
        self,
        template_id: StrictStr,
        apply_template_request: ApplyTemplateRequest,
        act_as_admin: Annotated[Optional[StrictBool], Field(description="Enable sudo-mode for admins for a single request, which gives full permission to all workspaces in the team.")] = None,
    ...
    def _apply_template_legacy_serialize(
        self,
        template_id,
        apply_template_request,
        act_as_admin,
