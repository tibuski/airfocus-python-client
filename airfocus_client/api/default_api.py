...
class DefaultApi:
    ...
    @validate_call
    def retrieve_inbox_view_counters(
        self,
        view_id: StrictStr,
        inbox_view_counters_request: InboxViewCountersRequest,
        ...
        :type view_id: str
        :param inbox_view_counters_request: (required)
        :type inbox_view_counters_request: InboxViewCountersRequest
        ...
        _param = self._retrieve_inbox_view_counters_serialize(
            view_id=view_id,
            inbox_view_counters_request=inbox_view_counters_request,
    ...
    @validate_call
    def retrieve_inbox_view_counters_with_http_info(
        self,
        view_id: StrictStr,
        inbox_view_counters_request: InboxViewCountersRequest,
        act_as_admin: Annotated[Optional[StrictBool], Field(description="Enable sudo-mode for admins for a single request, which gives full permission to all workspaces in the team.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[InboxViewCounter]]:
        """Retrieve counters of items in each tab of the view.
    ...
    @validate_call
    def retrieve_inbox_view_counters_without_preload_content(
        self,
        view_id: StrictStr,
        inbox_view_counters_request: InboxViewCountersRequest,
        act_as_admin: Annotated[Optional[StrictBool], Field(description="Enable sudo-mode for admins for a single request, which gives full permission to all workspaces in the team.")] = None,
    ...
    def _retrieve_inbox_view_counters_serialize(
        self,
        view_id,
        inbox_view_counters_request,
        act_as_admin,
        _request_auth,
        _content_type,
        _headers,
        ...
        if inbox_view_counters_request is not None:
            _body_params = inbox_view_counters_request
