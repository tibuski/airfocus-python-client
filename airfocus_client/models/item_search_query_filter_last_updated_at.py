...
class ItemSearchQueryFilterLastUpdatedAt(BaseModel):
    ...
    var_property: Optional[RefItemProperty] = Field(default=None, alias="property")
    __properties: ClassVar[List[str]] = ["mode", "value", "property"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "property": RefItemProperty.from_dict(obj["property"]) if obj.get("property") is not None else None
        })
        return _obj
