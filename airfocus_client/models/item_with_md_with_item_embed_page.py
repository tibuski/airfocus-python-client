...
class ItemWithMDWithItemEmbedPage(BaseModel):
    """
    ItemWithMDWithItemEmbedPage
    """ # noqa: E501
    total_items: StrictInt = Field(alias="totalItems")
    items: Optional[List[ItemWithMDWithItemEmbed]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ItemWithMDWithItemEmbed.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
