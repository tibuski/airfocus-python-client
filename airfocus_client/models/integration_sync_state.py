...
class IntegrationSyncState(BaseModel):
    ...
    failed_runs_count: StrictInt = Field(alias="failedRunsCount")
    success_count: StrictInt = Field(alias="successCount")
    __properties: ClassVar[List[str]] = ["errorCount", "failedRunsCount", "successCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failedRunsCount": obj.get("failedRunsCount"),
