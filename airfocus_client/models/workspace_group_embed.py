...
class WorkspaceGroupEmbed(BaseModel):
    ...
    workspaces: Optional[List[Workspace]] = Field(default=None, description="List of workspaces which belongs to this workspace-group.")
    __properties: ClassVar[List[str]] = ["permissions", "currentPermission", "workspaces"]
