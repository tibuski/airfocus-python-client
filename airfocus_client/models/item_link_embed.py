...
class ItemLinkEmbed(BaseModel):
    ...
    constraints: Optional[List[ItemLinkConstraintUndeletable]] = None
    __properties: ClassVar[List[str]] = ["apps", "fromWorkspaceId", "toWorkspaceId", "constraints"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "constraints": [ItemLinkConstraintUndeletable.from_dict(_item) for _item in obj["constraints"]] if obj.get("constraints") is not None else None
        })
        return _obj
