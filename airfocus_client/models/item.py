...
class Item(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["archived", "color", "createdAt", "description", "fields", "id", "lastUpdatedAt", "name", "order", "statusId", "workspaceId", "assigneeUserIds", "number", "statusCategoryUpdatedAt", "statusUpdatedAt"]
