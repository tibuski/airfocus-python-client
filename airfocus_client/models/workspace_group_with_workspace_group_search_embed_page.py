...
class WorkspaceGroupWithWorkspaceGroupSearchEmbedPage(BaseModel):
    """
    WorkspaceGroupWithWorkspaceGroupSearchEmbedPage
    """ # noqa: E501
    total_items: StrictInt = Field(alias="totalItems")
    items: Optional[List[WorkspaceGroupWithWorkspaceGroupSearchEmbed]] = None
    __properties: ClassVar[List[str]] = ["totalItems", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [WorkspaceGroupWithWorkspaceGroupSearchEmbed.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
