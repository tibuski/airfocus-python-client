    ...
    def make_instance(self, include_optional) -> ItemLinkWithItemLinkEmbedPage:
        ...
        if include_optional:
            return ItemLinkWithItemLinkEmbedPage(
                total_items = 56,
                items = [
                    airfocus_client.models.item_link_with_item_link_embed.ItemLinkWithItemLinkEmbed(
                        _embedded = airfocus_client.models.item_link_embed.ItemLinkEmbed(
                            apps = {
                                'key' : airfocus_client.models.item_link_embed_app.ItemLinkEmbedApp(
                                    data = null, 
                                    id = '', 
                                    type_id = '', )
                                }, 
                            constraints = [
                                airfocus_client.models.item_link_constraint_undeletable.ItemLinkConstraintUndeletable(
                                    extension_id = '', )
                                ], 
                            from_workspace_id = '', 
                            to_workspace_id = '', ), 
