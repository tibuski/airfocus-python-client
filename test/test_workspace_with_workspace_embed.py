    ...
    def make_instance(self, include_optional) -> WorkspaceWithWorkspaceEmbed:
        ...
        if include_optional:
            return WorkspaceWithWorkspaceEmbed(
                embedded = airfocus_client.models.workspace_embed.WorkspaceEmbed(
                    apps = {
                        'key' : airfocus_client.models.app.App(
                            id = '', 
                            settings = null, 
                            team_id = '', 
                            type_id = '', )
                    ...
                    children = [
                        airfocus_client.models.workspace_embed_relation.WorkspaceEmbedRelation(
                            relation_id = '', 
                            workspace = airfocus_client.models.workspace.Workspace(
                                alias = '', 
                    ...
                    integrations = {
                        'key' : airfocus_client.models.integration_summary.IntegrationSummary(
                            capabilities = airfocus_client.models.integration_capabilities.IntegrationCapabilities(
                                debug = True, 
                                hierarchy = True, 
                                push = True, 
                                sync = True, ), 
                            ...
                            last_sync_state = airfocus_client.models.integration_sync_state.IntegrationSyncState(
                                error_count = 56, 
                                failed_runs_count = 56, 
                                success_count = 56, ), 
                            settings = null, 
                            type_id = '', )
                        }, 
                    ...
                    views = {
                        'key' : airfocus_client.models.view.View(
                            description = '', 
                            id = '', 
                            item_filter = null, 
                            item_sort = [
                    ...
                    workspace_group = airfocus_client.models.workspace_embed_workspace_group.WorkspaceEmbedWorkspaceGroup(
                        id = '', 
                        name = '', 
                        order = 56, 
                        parent_id = '', ), ),
