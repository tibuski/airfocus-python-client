...
class TestItemComment(unittest.TestCase):
    """ItemComment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemComment:
        """Test ItemComment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemComment`
        """
        model = ItemComment()
        if include_optional:
            return ItemComment(
